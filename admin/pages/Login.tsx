    ...
    <div className="min-h-screen flex bg-white font-sans text-slate-900">
      ...
      <div className="hidden lg:flex lg:w-[55%] bg-[#0f172a] relative overflow-hidden flex-col justify-between p-20 select-none">
        ...
        <div className="relative z-10 max-w-lg">
          <h1 className="text-white text-6xl md:text-7xl font-serif leading-[1.1] tracking-tight">
            VCET:<br />
            <span className="text-slate-400 italic">Empowering</span><br />
            Administration
          </h1>
          <p className="mt-8 text-slate-400 text-lg leading-relaxed max-w-sm">
            Centralized command for college operations. Manage students, faculty, and institutional data with precision.
          </p>
        </div>
        ...
        <div className="relative z-10 flex items-center gap-6">
          ...
          <span className="text-slate-500 text-[10px] uppercase tracking-[0.4em] font-bold">Admin Portal V1.0</span>
        </div>
      </div>
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 sm:px-12 md:px-20 lg:px-24 xl:px-32">
        <div className="w-full max-w-sm mx-auto">
          {/* Header */}
          <div className="mb-12">
            <h2 className="text-3xl font-black tracking-tight text-slate-900 mb-2">Administrator Login</h2>
            <p className="text-slate-400 font-medium">Welcome back. Please authenticate to proceed.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between px-1">
                ...
                <Link to="#" className="text-[10px] font-black text-blue-600 uppercase tracking-wider hover:text-blue-700 transition-colors">
                  Forgot Password?
                </Link>
              </div>
              <div className="relative group">
            ...
            <div className="flex items-center ml-1">
              <label className="flex items-center gap-3 cursor-pointer group">
                <div className="relative flex items-center justify-center">
                  ...
                  <svg className="absolute w-3 h-3 text-white scale-0 peer-checked:scale-100 transition-transform" fill="none" stroke="currentColor" strokeWidth={4} viewBox="0 0 24 24"><path d="M5 13l4 4L19 7" /></svg>
                </div>
                <span className="text-xs font-bold text-slate-500 group-hover:text-slate-800 transition-colors">Remember session</span>
              </label>
            </div>
          ...
          <div className="mt-20 pt-10 border-t border-slate-100/60 text-center">
            <div className="flex items-center justify-center gap-2 text-[#2563eb] mb-3">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest">Single Sign-On Secure</span>
            </div>
