...
const MMSTrainingPlacementForm: React.FC = () => {
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-extrabold text-[#111827]">Edit MMS Training & Placement</h1>
        </div>
      </div>
...
export default MMSTrainingPlacementForm;
