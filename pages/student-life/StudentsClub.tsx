    ...
    <div ref={ref} className={`space-y-12 p-8 lg:p-12 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 items-center">
        <div className="lg:col-span-3 space-y-5 text-[#475569] leading-relaxed text-[15px]">
          ...
          <p>
            The Mechanical Engineering Department of VCET is associated with SAEINDIA from long time. The department has renewed its registration once again in the year 2019-20. The committee of SAE INDIA COLLEGIATE CLUB OF VCET with registration no. SAEICC WIS234 in the month of Sept 2019. Various teams like Team ETHAN, Team SOLECTHON, Team CENTURION participates in national level events under the umbrella of SAE-VCET committee.
          </p>
          <div className="flex flex-wrap gap-3 pt-2">
            {['Team ETHAN', 'Team SOLECTHON', 'Team CENTURION', 'Mobility', 'Design'].map((tag) => (
...
const StudentsClub: React.FC = () => {
  ...
  return (
    <PageLayout>
      <PageBanner
        title="Student Club"
        subtitle="Advancing mobility technology through innovation and competition."
        breadcrumbs={[
          { label: 'Student Club' },
        ]}
      />
